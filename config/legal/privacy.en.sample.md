...
> **Sample file.** Copy this file to `privacy.en.md` in this same directory and edit it with your operator details. For French, copy `public/legal/privacy.fr.md` to `privacy.fr.md` here.
