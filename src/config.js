...
const ENV_OVERRIDES = [
  ...
  { env: 'CPADMIN_OCPP_V201_ENABLED', path: ['ocpp', 'v201', 'enabled'] },
  {
    ...
    path: ['ocpp', 'v201', 'enforceSecurityProfile'],
  },
  { env: 'CPADMIN_OCPP_TRUST_PROXY_PROTO', path: ['ocpp', 'trustProxyProto'] },
...
const CONFIG_FIELDS = [
  ...
  {
    key: 'ocpp.wss.clientCa.certFile',
    section: 'ocpp',
    type: 'string',
    required: false,
    sensitive: false,
  ...
  {
    key: 'ocpp.v201.enforceSecurityProfile',
    section: 'ocpp',
    type: 'boolean',
    required: false,
    sensitive: false,
